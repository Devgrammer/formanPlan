...
function HCard() {
    ...
    return (
       <div>
            <div className="v-card bg-cover  w-w480 h-h240 antialiased shadow-active hover:transition-prime flex-col space-y-1   rounded-2xl p-8  hover:shadow-md " style={ { backgroundImage: `${addr}` } }>
